...
int main() {
    ...
    cout << endl;
    cout << "~~~~~~~~~~~~~~~~~~~~" << endl;
    add("4523210666", "susu uht", 		75, &Q);
    add("4523210777", "ultra milk", 	85, &Q);
    add("4523210888", "cap kaki tiga",  65, &Q);
    add("4523210999", "cincau",			55, &Q);
    add("4523210555", "sosis", 			85, &Q);
    add("4523210444", "gorengan", 		65, &Q);
    add("4523210222", "beras", 			55, &Q);
    CetakQueue(Q);
    cout << "=====================" << endl;
    cout << endl;
    cout << endl;
